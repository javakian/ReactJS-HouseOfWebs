      ...
      <Consumer>
        {context => (
          <div className="home-wrapper">
            ...
            <br /><p>Links network page page page page page page sections</p>   <br /> 
              <h1>{context.intro.title}</h1>
              <p>{context.intro.description}</p> 
           
              <br /><p>Links page page page page page page page sections</p>   <br /> <br />     <hr />      <br /> 
              <h1>{context.intro2.title}</h1>
              <p>{context.intro2.description}</p>
            </header>
            <div>
              <ul className="list">
